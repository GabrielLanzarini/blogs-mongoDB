...
export default function NavBar() {
    ...
    return (
        <div ref={modal} className={style.navBar}>
            <div className={style.searchInputContainer}>
                <input ref={inputRef} type="text" placeholder="Search for blogs or people" />
                <svg onClick={handleFocus} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                </svg>
            </div>
            <div onMouseLeave={handleCloseModal} className={style.profileContainer}>
                {showModal && (
                    <div className={style.modal}>
                        <div className={style.modalInt}>
                            <Link to={`/home/profile/${"ghl20"}`} className={style.modalOptContainer}>
                            ...
                            {/* <div className={style.modalOptContainer}>
                            ...
                            <div className={`${style.modalOptContainer} ${style.modalOptContainerLogout}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                ...
                <div className={style.profileContainerInt}>
                    {showModal ? (
                        <svg onClick={handleModal} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
